            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="formAccount">
                        <h1 class="bingoAccountTitle">History Order</h1>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if($pengaturan->checkoutType==3) 
                                                            @if($item->status < 4)
                                                            <button onclick="window.open('{{url('konfirmasipreorder/'.$item->id)}}','_blank')" class="btnbingoOne" data-title="Edit" data-placement="top" data-tip="tooltip"><i class="fa fa-eye"></i></button>
                                                            @endif 
                                                        @endif
                                                        @if($pengaturan->checkoutType==1) 
                                                            @if($item->status <= 1)
