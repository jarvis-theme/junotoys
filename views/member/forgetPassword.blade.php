                        ...
                        <div class="wpb_column vc_column_container vc_col-sm-12">
                            <div class="vc_column-inner ">
                                <div class="wpb_wrapper">
                                    ...
                                    <h1 class="sc_title sc_title_regular sc_align_center text_uppercase">Reset Password</h1>
                                    <div id="sc_form_777_wrap" class="sc_form_wrap">
                                        <div id="" class=" sc_form_style_form_1 aligncenter">
                                            <form id="" class="sc_input_hover_default" data-formtype="" method="post" action="{{url('member/forgetpassword')}}">
                                                <div class="sc_form_info">
                                                    <div class="columns_wrap">
                                                        <div class="sc_form_item sc_form_field label_over column-1_2">
                                                            <input id="sc_form_username" type="text" name="recoveryEmail" value="{{ Input::old('recoveryEmail') }}" placeholder="Email *" aria-required="">
                                                        </div>
                                                        <br>
                                                    </div>
                                                </div>
